...
public class RaFactoryImpl extends EFactoryImpl implements RaFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case RaPackage.STUDY_PLAN: return createStudyPlan();
			case RaPackage.SPECIALIZATION: return createSpecialization();
			case RaPackage.SEMESTER: return createSemester();
			case RaPackage.MANDATORY_COURSE: return createMandatoryCourse();
			default:
